...
//--- Page Events
function activate() {
  var baseUri="http://http://192.168.160.58/Olympics/api/games"
  console.log("Loading Map")
  var map= L.map('map',{zoomSnap: 0.5}).on("click", function(e){var coord= e.LatLon;console.log(coord)}).setView([15,12],2);
